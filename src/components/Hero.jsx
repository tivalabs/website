                ...
                >
                    ...
                    <div className="flex flex-row gap-6 justify-center">
                        <a
                            ...
                            className="px-8 py-4 bg-transparent border border-white/20 text-white font-exo font-semibold text-sm tracking-widest uppercase rounded-full hover:bg-white/10 transition-colors duration-300 inline-flex items-center justify-center gap-3"
                        >
