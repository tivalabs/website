                ...
                >
                    ...
                    <div className="flex flex-row gap-6">
                        <a
                            ...
                            className="px-8 py-4 bg-primary text-black font-exo font-semibold text-sm tracking-widest uppercase rounded hover:bg-white transition-colors duration-300 inline-flex items-center justify-center gap-3"
                        >
                        ...
                        <a
                            href="#"
                            className="px-8 py-4 bg-transparent border border-white/20 text-white font-exo font-semibold text-sm tracking-widest uppercase rounded hover:bg-white/10 transition-colors duration-300 inline-flex items-center justify-center"
                        >
                            <span className="pt-[1px]">Docs</span>
                        </a>
                    </div>
                </motion.div>
            </div>
